...
class CustomAlertDialog extends StatelessWidget {
  ...
  const CustomAlertDialog(
      ...
      this.titlePadding,
      this.content,
      this.contentPadding: AppPaddings.alertContentPadding,
      this.actions,
      this.semanticLabel,
      ...
      children.add(Container(
        decoration: BoxDecoration(
          borderRadius: BorderRadius.only(
              topLeft: Radius.circular(AppRoundCorners.radius),
              topRight: Radius.circular(AppRoundCorners.radius)),
        ),
        // color: Colors.orange,
        child: new Padding(
          padding: EdgeInsets.all(0.0),
          // padding: titlePadding ??
          //     new EdgeInsets.fromLTRB(72 / AppConstants.ration, 16.0,
          //         72 / AppConstants.ration, 14.0),
          child: Row(
            mainAxisAlignment: MainAxisAlignment.spaceBetween,
            children: <Widget>[
              Padding(
                padding: EdgeInsets.fromLTRB(
                    72 / AppConstants.ration, 16.0, 0.0, 14.0),
...
class SimpleDialog extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    Widget dialogChild = new IntrinsicWidth(
      stepWidth: 56.0,
      child: new ConstrainedBox(
        constraints: const BoxConstraints(minWidth: 280.0, maxWidth: 336.0),
        child: new Column(
          mainAxisSize: MainAxisSize.min,
          crossAxisAlignment: CrossAxisAlignment.stretch,
          children: body,
